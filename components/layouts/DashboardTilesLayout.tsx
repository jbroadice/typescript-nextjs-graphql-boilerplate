import { Section, Box, Tile, Heading, Image } from "react-bulma-components";

const DashboardTilesLayout: React.FunctionComponent = () => (
  <Section>
    <Box>
      <Tile kind="ancestor">
...
export default DashboardTilesLayout;
